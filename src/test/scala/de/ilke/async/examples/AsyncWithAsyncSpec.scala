...
class AsyncWithAsyncSpec extends AsyncFlatSpec {
  ...
  // TODO  show complete lastly to cleanup the fixture
  // TODO add more interesting example with set up tear down method for fixture here
